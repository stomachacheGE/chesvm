...
% Evaluate performance(accuracies) of the learned model on test data
%
% By Liangcheng Fu.
%
...
results.mean_accuraccy = mean(results.acc_per_cls);
...
% store the misclassifications into a .txt file
